...
export const metadata: Metadata = {
  ...
  description: 'Engineered in India. Premium 5.1-channel home-theatre remote control kits, DSP decoder boards, and HDMI audio modules.',
};

export default function RootLayout({children}: {children: React.ReactNode}) {
  return (
    <html lang="en" suppressHydrationWarning className={`${inter.variable} ${playfair.variable}`}>
      <body suppressHydrationWarning className="bg-[#FFFFFF] text-[#111111] font-sans min-h-screen flex flex-col antialiased selection:bg-[#C6A96B] selection:text-[#111111] relative overflow-x-hidden">
