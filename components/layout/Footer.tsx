        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-[#6B6B6B]">
              ...
              <li>
                <Link href="/dealer-enquiry" className="inline-flex items-center text-[#111111] font-bold text-[10px] tracking-widest uppercase hover:text-gold-500 transition-colors mt-2">
